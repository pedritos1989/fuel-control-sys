 ...
 */
class Version20180301190932 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('DROP INDEX UNIQ_2FEC6D5FE899029B ON s_asignacion_mensual');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_27AE609484712DFB ON s_plan_asignacion (asignacion_mensual_id)');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_2FEC6D5FE899029B ON s_asignacion_mensual (plan_id)');
        $this->addSql('ALTER TABLE s_plan_asignacion DROP FOREIGN KEY FK_27AE609484712DFB');
        $this->addSql('DROP INDEX UNIQ_27AE609484712DFB ON s_plan_asignacion');
